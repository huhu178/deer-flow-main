...
import { MedicalWelcome } from "./medical-welcome";
 ...
 */
export function MedicalConversationStarter({
  className,
  onSend,
}: {
  className?: string;
  ...
  return (
    <div className={cn("flex flex-col items-center", className)}>
      <div className="pointer-events-none fixed inset-0 flex items-center justify-center">
        <MedicalWelcome className="pointer-events-auto mb-15 w-[75%] -translate-y-24" />
      </div>
