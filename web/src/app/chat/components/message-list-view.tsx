          ...
          >
            <MessageBubble message={message}>
              <div className="flex w-full flex-col">
                <Markdown className="prose-lg text-lg">{message?.content}</Markdown>
              </div>
            </MessageBubble>
          </div>
        ) : null;
...
function PlanCard({
  ...
  return (
    <Card className={cn("w-full", className)}>
      ...
      <CardContent>
        <Markdown className="opacity-80 prose-lg text-lg" animate>
          {plan.thought}
        </Markdown>
        {plan.steps && (
          <ul className="my-2 flex list-decimal flex-col gap-4 border-l-[2px] pl-8">
            {plan.steps.map((step, i) => (
              <li key={`step-${i}`}>
                <h3 className="mb text-xl font-medium">
                  <Markdown className="prose-lg text-lg" animate>{step.title}</Markdown>
                </h3>
                <div className="text-muted-foreground text-base">
                  <Markdown className="prose-base text-base" animate>{step.description}</Markdown>
                </div>
              </li>
            ))}
          </ul>
